...
#
path = "/mnt/ceph/users/cmodi/contrastive/analysis/z10/zheng07/"
...
ndim = len(params_fid)
hod_params = np.load('/mnt/ceph/users/cmodi/contrastive/data/z01/zheng07/hodp.npy')
...
#####
### Dataloader
pk = np.load('/mnt/ceph/users/cmodi/contrastive/data/z01/zheng07/power.npy')
k = np.load('/mnt/ceph/users/cmodi/contrastive/data/z01/zheng07/0000/power_0.npy')[:, 0]
ngal = np.load('/mnt/ceph/users/cmodi/contrastive/data/z01/zheng07/gals.npy')[..., 0]
